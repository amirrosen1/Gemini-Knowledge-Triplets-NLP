...
def collect_proper_entity(node):
    """
    Collect proper entities including compound children.

    Parameters:
        node (spacy.Token): The token representing the entity head.

    Returns:
        set: Set of strings representing the entity group.
    """
